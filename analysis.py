# analysis.py
# Weather analysis and prediction algorithms
# All algorithms implemented from scratch to demonstrate understanding
...
def find_extremes(records):
    ...
    sorted_records = merge_sort(records, key="temperature")
...
def predict_next_hours(records, hours_ahead=24):
    ...
    y = [float(r["temperature"]) for r in records]

    slope, intercept = linear_regression(x, y)

    predictions = []
    for i in range(1, hours_ahead + 1):
        future_x = len(records) + i
